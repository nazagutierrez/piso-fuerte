...
const buttons = [
  ...
  },
  {
    ...
    icon: <FaWhatsapp className="group-hover:text-[#25D366] transition-all" />,
    text: "Whatsapp",
  },
{
...
export default function Hero() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(".hero-cta-work-item",
        { opacity: 0, y: 60, filter: "blur(15px)", ease: "power3.out", duration: 1, delay: 1.2 },
  ...
  return (
    ...
    >
      {/* SVG para el gradiente de Instagram */}
        ...
        <div className="gap-12 items-center">
          <div >
            ...
            <div className="items-center justify-center mt-4 flex flex-wrap gap-4">
              ...
              >
                <span className="ps-2">Ver Trabajos</span> <FiArrowRight />
              </Link>
            </div>
          </div>
        </div>
